...
<td> <input type="text" name="firstname" value="<%=firstname %>" class="long" pattern="[a-z,A-Z]{3,20}" title="First Name must be containt atleast 3 character" required/></td>

</tr>
<tr>
<td align="right">Last Name:</td>
<td> <input type="text" name="lastname" value="<%=lastname %>" class="long" pattern="[a-z,A-Z]{3,20}" title="First Name must be containt atleast 3 character"required/></td>
</tr>
<tr>
